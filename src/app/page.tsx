        ...
        <div className="relative isolate">
          ...
          <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            <div 
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80bf] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]" />
          </div>
          {/*Features*/}
            ...
            <div className="mb-12 px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                ...
                <p className="mt-4 text-lg text-gray-600">
                  Chatting to your PDF can never been easier than with Texter.
                </p>
              </div>
            </div>
              ...
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    We&apos; ll process your file and make it ready for you to chat with it.
                  </span>
                </div>
              </li>
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    It&apos;s that simple.Try out Texter today - it really takes less than a minute
                  </span>
                </div>
              </li>
            </ol>
